$(document).ready(function() {
        ...
        $f("a.flowplayer", "flowplayer/flowplayer-3.2.7.swf", {
            ...
            plugins: {
                rtmp: {
                    ...
                    netConnectionUrl: 'rtmp://192.168.222.5/live',//url, // ex: 'rtmp://192.160.0.100/video/183f0bf3a0982a127bdb8161e0c44eb696b3e75c-1328884719358',
		    subscribe: true,
                }
            }
        });
    ...
    setup_jwplayer("#wrapper", "96.244.235.225", "broadcast", "broadcast");
});
